...
from typing import IO, Any, Dict, Iterator, Optional, Protocol, Union
...
class KartonServiceInfo:
    ...
    identity: str
    karton_version: str
    service_type: KartonServiceType = KartonServiceType.OTHER
...
def parse_redis_client_name(client_name: str) -> KartonServiceInfo:
    ...
    service_type = KartonServiceType(
        params.get("service_type", KartonServiceType.OTHER.value)
    )
